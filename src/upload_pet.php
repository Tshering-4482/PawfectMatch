...
<html lang="en">
  <head>
    ...
    <title>Upload Pet Dog|| Dashboard</title>
    ...
    <div class="row">
        ...
        <div class="position-sticky pt-3">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="upload_pet.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="form-container">
                ...
                <form action="process_upload_dog.php" method="POST" enctype="multipart/form-data">
