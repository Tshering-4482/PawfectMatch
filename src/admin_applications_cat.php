...
<html lang="en">
  <head>
    ...
    <title>Cat Applicants|| Dashboard</title>
      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="admin_applications_cat.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <?php
            ...
            $sql = "SELECT adoption_applications.*, pet_cat.name AS cat_name, pet_cat.breed, pet_cat.sex 
                    FROM adoption_applications
                    INNER JOIN pet_cat ON adoption_applications.cat_id = pet_cat.cat_id";
